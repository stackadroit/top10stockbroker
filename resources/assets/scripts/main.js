...
import { faAngleDown, faAngleUp, faAngleRight, faChevronDown, faPhone, faSearch, faBars, faTimes, faBell, faCaretDown, faCaretUp, faArrowDown, faArrowUp, faQuestionCircle, faQuestion} from '@fortawesome/free-solid-svg-icons';
...
library.add(faCaretDown, faCaretUp, faArrowDown, faArrowUp, faAngleDown, faAngleUp, faAngleRight, faChevronDown, faPhone, faFacebookF, faTwitter, faLinkedin, faPinterest, faReddit, faQuestionCircle, faWhatsapp, faTelegram, faTumblr, faMixcloud ,faYoutube, faSearch, faBars, faTimes, faBell);
