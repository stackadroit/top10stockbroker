import {marginCalculator}  from '../../library/brokerage/margin-calculator';
import {PaTabs}  from '../../library/global';
// import {immyBox}  from '../../Plugins/immybox';
export default {
  init() {
    // Commom Plugins
	(function($) {
    ...
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
      ...
      return ImmyBox;
		...
		if (typeof marginCalculator !== 'undefined') {
			marginCalculator.initialize();
		}
		if (typeof PaTabs !== 'undefined') {
			PaTabs.initialize();
		}
		// if (typeof immyBox !== 'undefined') {
		// 	immyBox.initialize();
		// }
	}).apply(this, [jQuery]);
  },
