  ...
  init() {
     (function($) {
      const config = {
        ...
        const oneyearchartElement = document.getElementById('oneyearchart'); 
        ReactDOM.render(<ReactHighcharts config = {config}></ReactHighcharts>, oneyearchartElement);
