			...
			if(finCode){
				$.ajax({
		         	...
		         	beforeSend: function() {
			      	...
			      	type:"post",
			     	dataType: "html",
			      	url: global_vars.apiServerUrl + '/apiblock/sma-stock-forecast-calculator-html',
	             	data: {
			          	'finCode':finCode,
			         	'post_id':post_id,
			         	'filter':filter,
			...
			if(finCode){
				$.ajax({
		         	...
		         	beforeSend: function() {
			      	...
			      	type:"post",
			     	dataType: "html",
			      	url: global_vars.apiServerUrl + '/apiblock/sma-stock-forecast-calculator',
	             	data: {
			          	'finCode':finCode,
			         	'post_id':post_id,
			         	'filter':filter,
			...
			if(indexCode){
				$.ajax({
		         	...
		         	beforeSend: function() {
			      	...
			      	type:"post",
			     	dataType: "html",
			      	url: global_vars.apiServerUrl + '/apiblock/sma-indices-forecast-calculator-html',
	             	data: {
			          	'indexCode':indexCode,
			         	'post_id':post_id,
			         	'filter':filter,
			...
			if(indexCode){
				$.ajax({
		         	...
		         	beforeSend: function() {
			      	...
			      	type:"post",
			     	dataType: "html",
			      	url: global_vars.apiServerUrl + '/apiblock/sma-indices-forecast-calculator',
	             	data: {
			          	'indexCode':indexCode,
			         	'post_id':post_id,
			         	'filter':filter,
