...
class IndicesSoIndicator extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            isRefreshing : false,
    ...
    getData(){
      const data = new FormData();
        ...
        data.append('paged',1);
        axios.post(global_vars.apiServerUrl + '/apiblock/main-so-indices-list', data)
          .then(res => {
...
export default IndicesSoIndicator;
