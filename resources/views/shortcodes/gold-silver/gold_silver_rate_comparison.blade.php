			    ...
			    <div class="inner-wrap">
			        ...
			        <div class="retcalc_form gold-calc forms_container">
			            <form action="">
                            ...
                            <div class="__gold_silver_rate_comparision">
			                ...
			                <div class="pt-4 text-center">
			                    <button type="submit" class="margin-cal colormag-button calculate_margin getGoldSilverUnitCompareCalculatedResult">Compare {{($type ==1)?'Gold':'Silver' }} Rate</button>
			                </div>
			                <div class="cal-res-table-wrap get_gold_silver_compare_unit_result"></div> 
			            </form>
			        </div>
			    </div>
			</div>
