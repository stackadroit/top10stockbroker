<div data-id="{{@$id}}" data-calculate-button="{{ @$calculate_button }}" id="ema-stock-forecast-calculator">
    ...
    <div class="tab-content" id="myTabContent">
        <div id="emaForeCastStock" class="tab-pane fade show active" data-fincode="{{@$fin_code}}" data-filter="{{@$stock_filter}}">
        </div>
        <div id="emaForeCastIndices" class="tab-pane fade" data-index-code="{{@$index_code}}" data-filter="{{@$index_filter}}">
        </div>
    </div>
    @else
        @if($type =='Stock')
        ...
        @else
        <div id="emaForeCastIndices" class="tab-pane fade show active" data-index-code="{{@$index_code}}" data-filter="{{@$index_filter}}">
            </div>
        @endif
    @endif
