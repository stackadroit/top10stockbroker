    ...
    <div class="inner-wrap">
        ...
        <div class="row align-items-end n-tab-wrap">
            <ul class="tabs commn_tabs col-md-8">
              <li><a href="#topInterestIndexOptionCall" class="changeTOIIFilter" data-expdate="{{@$ExpDate}}" data-otpfilter="{{@$Opt}}">CALL</a></li>
              <li><a href="#topInterestIndexOptionPut" class="changeTOIIFilter" data-expdate="{{@$ExpDate}}" data-otpfilter="{{@$Opt}}">PUT</a></li>
            </ul>
        ...
        <div id="topInterestIndexOptionCall" class="tab_content">
        ...
        <div id="topInterestIndexOptionPut" class="tab_content">
           <div class="scrollbar-inner">
            <table class="table-style1 mb-0">
                <thead>
                    <tr>
