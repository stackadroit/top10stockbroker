<div class="section_corporateact bg-light section-padding">
    <div class="inner-wrap">
        ...
        <ul class="tabs commn_tabs col-md-8">
          <li><a href="#topInterestStockOptionCall" class="changeTOISFilter" data-expdate="{{@$ExpDate}}" data-otpfilter="{{@$Opt}}">CALL</a></li>
          <li><a href="#topInterestStockOptionPut" class="changeTOISFilter" data-expdate="{{@$ExpDate}}" data-otpfilter="{{@$Opt}}">PUT</a></li>
        </ul>
        ...
        <div id="topInterestStockOptionCall" class="tab_content">
        ...
        <div id="topInterestStockOptionPut" class="tab_content">
           <div class="scrollbar-inner">
            <table class="table-style1 mb-0">
                <thead>
                    <tr>
