<div class="section_corporateact bg-light section-padding">
    <div class="inner-wrap">
        ...
        <div class="row align-items-end n-tab-wrap">
          ...
          <li><a href="#topInterestIndexOptionHighest"  class="changeTOIIFilter" data-expdate="{{@$ExpDate}}"  >Highest</a></li>
          <li><a href="#topInterestIndexOptionLowest"  class="changeTOIIFilter" data-expdate="{{@$ExpDate}}"  >Lowest</a></li>
        </ul>
        ...
        <div id="topInterestIndexOptionHighest" class="tab_content">
        ...
        <div id="topInterestIndexOptionLowest" class="tab_content">
          <div class="scrollbar-inner">
            <table class="table-style1 mb-0">
                <thead>
                    <tr>
