...
add_action('wp_enqueue_scripts', function () {
    wp_enqueue_style('top10stockbroker/main.css', asset_path('styles/main.css'), '1.0.1', true);
    wp_enqueue_script('top10stockbroker/main.js', asset_path('scripts/main.js'), ['jquery'], '1.0.1', true);
